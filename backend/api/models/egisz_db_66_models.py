...
class VimisSending(models.Model):
    ...
    medical_organization_id = models.CharField(max_length=50, blank=True, null=True)
    medical_organization_extension = models.CharField(max_length=50, blank=True, null=True)
    medical_organization_name = models.TextField(blank=True, null=True)
    medical_organization_city = models.TextField(blank=True, null=True)
    medical_organization_extension_name = models.TextField(blank=True, null=True)
